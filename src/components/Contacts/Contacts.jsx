...
background: `linear-gradient(90deg, #FEAF02 10.22%, #F3E3B7 125.62%)`,
  ...
  return (
    <>
    <div className="" style={contact} id='pricing'>
        <Container>
            <div className="" style={{padding:"10% 0%"}}>
                <p style={{fontSize:"40px",width:"50%",fontWeight:"700",lineHeight:"49px",color:"#4A4747",letterSpacing:"-2px",textTransform:"capitalize"}}>Get in touch with us if you're  <span style={{color:"#11998E"}}>interested</span>  in learning more about our <span style={{color:"#2AB866"}}>services.</span></p>
