...
function Service() {
  return (
    <>
    <div className="services" style={{padding:"5% "}}>
        <Container>
            <div className="">
                <div className="text" style={{position:"absolute"}}>
                    <p style={{fontSize:"40px",fontWeight:"700",color:"#4A4747",lineHeight:"49px",letterSpacing:"-2px",width:"35%"}}>Make a Lasting <span style={{color:"#11998E"}}>Impression</span> With iCards User Friendly <span style={{color:"#2AB866"}}>Features</span></p>
                </div>
                <div className="grid" style={{display:"grid",gridTemplateColumns:"auto auto auto",alignItems:"center",textAlign:"center",position:"relative",gap:"10px",marginLeft:"50px"}}>
                <div></div>
